...
![/assets/img/2023-10-39-kafka/Untitled](/assets/img/2023-10-39-kafka/Untitled%201.png)
...
table에 데이터 변경사항을 Capture하는 부분을 데모하고 발표
...
metrics.enabled=false # 여기서 메트릭을 비활성화합니다.
